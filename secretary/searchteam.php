            ...
            <div class="container-fluid"> <!-- ============ PAGE CONTENT ============= -->
                ...
                <?php
                    if (isset($_GET['submit'])) {
                        ...
                        if ($name) {
                            ...
                            $sql = mysqli_query($con,"SELECT * FROM teams WHERE name = '$name'");
                ...
                ?>
                            <div class="panel panel-default listbtn-panel">
                                <a class="listbtn" href="editteam.php?teamid=<?=$result_array['team_id']?>"><div class="panel-body listbtn"><?=$result_array['name']?></div></a>
                            </div>
                <?php
                        }
                    }
